      ...
      <div className="bg-slate-900 text-slate-300 text-xs py-1.5 px-4 sm:px-8 flex flex-wrap justify-between items-center gap-2 border-b border-slate-800">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className={`px-2 py-0.5 rounded text-xs transition flex items-center gap-1 ${theme === 'high-contrast' ? 'bg-amber-400 text-slate-950 font-bold' : 'bg-slate-800 text-slate-300 hover:bg-slate-700'
              }`}
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-4">
        ...
        <nav className="hidden lg:flex items-center space-x-1">
          {[
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-semibold transition-all flex items-center gap-1.5 ${activeTab === item.id
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`px-2.5 py-1.5 rounded-lg text-xs font-bold transition flex items-center gap-1 ${activeTab === 'kiosk'
          ...
          <button
            ...
            className={`px-2.5 py-1.5 rounded-lg text-xs font-bold transition flex items-center gap-1 ${activeTab === 'admin'
            ...
            <div className="relative">
              ...
              {userDropdownOpen && (
                <div className="absolute right-0 mt-1 w-40 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl py-1 z-50">
                  ...
                  >
                    <UserIcon className="w-3.5 h-3.5" /> {t.navProfile}
                  </button>
                  <button
      ...
      <div className="lg:hidden flex items-center justify-around bg-slate-50 dark:bg-slate-800/90 border-t border-slate-200 dark:border-slate-700 py-1.5 px-2 text-xs">
        {[
          ...
          <button
            key={item.id}
            onClick={() => setActiveTab(item.id)}
            className={`px-2 py-1 rounded text-xs font-medium transition ${activeTab === item.id
